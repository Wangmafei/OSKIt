...
Pod::Spec.new do |s|
  ...
  s.name         = "OSKit"
  s.version      = "1.0.0"
  s.summary      = "A short description of OSKit."
  ...
  # Or just: s.author    = "Wangmafei"
  # s.authors            = { "Wangmafei" => "wangmafei@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Wangmafei"
